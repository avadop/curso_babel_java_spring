...
public class CajeroServiceImpl implements CajeroService {
	...
	public void ingresar(int numCuenta, double cantidad) {
		...
		this.movimientos.addMovimiento(new Movimiento(1, numCuenta, new Date(), cantidad, "ingreso"));
	}
	...
	public boolean extraccion(int numCuenta, double cantidad) {
		...
		if(resta < 0)
			...
			this.movimientos.addMovimiento(new Movimiento(1,numCuenta,new Date(),cantidad,"extraccion"));
