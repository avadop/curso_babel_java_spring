...
public class Main {
	...
	private static void menu() {
		//Abstraemos la capa presentacion de la de negocio.
		//Spring: Inyeccion de objetos
		@SuppressWarnings("resource")
		BeanFactory factory = new ClassPathXmlApplicationContext("springConfig.xml");
		//Podemos poner el tipo directamente para llamar a la instancia de la interfaz
		//AgendaService agenda =  factory.getBean(AgendaService.class); 
		//O el identificador del bean en la clase config
		AgendaService agenda = (AgendaService) factory.getBean("agendaService");
		int op;
		do {
