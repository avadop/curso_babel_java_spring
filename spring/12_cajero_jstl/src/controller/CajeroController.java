...
public class CajeroController {
	...
	//Ver los titulares de la cuenta
	@GetMapping(value="verTitulares")
	public String titulares(HttpServletRequest request, HttpSession session) {
		request.setAttribute("getTitulares", this.cajero.titularesCuenta((int)session.getAttribute("getNumCuenta")));
		return "titulares";
	}
}
