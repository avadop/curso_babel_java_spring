...
public class Cuenta implements Serializable {
	...
	//Indican la relacion que hay entre la tabla de join y las otras dos tablas.
				//La otra tabla con la que se une
				inverseJoinColumns = @JoinColumn(name="idCliente",referencedColumnName = "dni"),
				//La tabla donde estás actualmente (propietaria de la relacion)
				joinColumns =@JoinColumn(name="idCuenta",referencedColumnName = "numeroCuenta"))
